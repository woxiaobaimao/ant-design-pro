        ...
        routes: [
          ...
          },
          {
            ...
            routes: [
              {
                name: 'taskTemplate',
                path: '/pipeline/pipelineConfig/taskTemplate',
                component: './pipeline/pipelineConfig/taskTemplate',
              },
              {
                name: 'stepTemplate',
                path: '/pipeline/pipelineConfig/stepTemplate',
                component: './pipeline/pipelineConfig/stepTemplate',
              },
              {
      ...
      },
      {
        ...
        routes: [
          { path: '/form/basic-form', name: 'basicform', component: './Forms/BasicForm' },
          {
            ...
            hideChildrenInMenu: !(exports.default = void 0),
            routes: [
